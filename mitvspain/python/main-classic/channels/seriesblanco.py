...
BUSCAR = "https://seriesblanco.com/finder.php"
...
def mainlist(item):
    ...
    thumb_series_az = get_thumb("squares", "thumb_canales_series.png")
    ...
    itemlist.append(Item(channel=item.channel, title="Series por género", action="generos",
                         url=HOST, thumbnail=thumb_series))
    itemlist.append(Item(channel=item.channel, title="Buscar...", action="search", url=BUSCAR,
